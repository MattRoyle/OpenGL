...
int main()
{
	...
	glUniform1f(glGetUniformLocation(lightingShader.programID, "light.linear"), 0.09f);
	glUniform1f(glGetUniformLocation(lightingShader.programID, "light.quadratic"), 0.032f);
